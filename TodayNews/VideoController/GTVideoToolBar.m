...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self addSubview:({
            ...
            _commentImageView.contentMode = UIViewContentModeScaleToFill;
            _commentImageView;
        })];
...
- (void)layouWithModel:(id)model {
    ...
    [NSLayoutConstraint activateConstraints:@[
         ...
         [NSLayoutConstraint constraintWithItem:_nickLabel attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeCenterY multiplier:1 constant:0],
